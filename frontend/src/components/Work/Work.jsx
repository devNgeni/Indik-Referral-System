      ...
      <TableIcon>
        ...
        <WorkDiv>
          <WorkSteps>
            ...
            <WorkSpan>Purchase a Licence for $50</WorkSpan>
          </WorkSteps>
          <WorkSteps>
            <WorkImg>
              <img src={work} alt="Icon" />
            </WorkImg>
            <WorkSpan>Receive an Invitation code</WorkSpan>
          </WorkSteps>
          <WorkSteps>
            <WorkImg>
              <img src={work} alt="Icon" />
            </WorkImg>
            <WorkSpan>indik your friends and family</WorkSpan>
          </WorkSteps>
          <WorkSteps>
            <WorkImg>
              <img src={work} alt="Icon" />
            </WorkImg>
            <WorkSpan>Get $25 for each activated Invitation</WorkSpan>
          </WorkSteps>
          <WorkSteps>
            <WorkImg>
              <img src={work} alt="Icon" />
            </WorkImg>
            <WorkSpan>Invite as many People as You Can</WorkSpan>
          </WorkSteps>
        </WorkDiv>
